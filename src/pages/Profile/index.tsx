                  ...
                  <div className='mt-10 flex flex-col gap-16'>
                    <div className='flex gap-10'>
                      ...
                      <div className='w-[600px]'>
                        ...
                        <p className='text-[1.3rem] text-[#878484] mt-2'>
                          Họ và tên chủ tài khoản, cũng là tên của tài khoản hiển thị trên website. Bạn có thể thay đổi
                          ở phần thay đổi thông tin cá nhân
                        </p>
                      </div>
                    </div>
                    <div className='flex gap-10'>
                    ...
                    <div className='flex gap-10'>
                      ...
                      <div className=' flex justify-between items-center gap-32'>
                        ...
                        <div onClick={handleToChangePassword}><Button changePassword>Thay đổi</Button></div>
                      </div>
                    </div>
                    <div className='flex gap-10'>
                      <div className='w-[60px] h-[60px] flex justify-center items-center rounded-[50%] bg-[#f55960]'>
                      ...
                      <div className='w-[600px]'>
                        ...
                        <p className='text-[1.3rem] text-[#878484] mt-2'>
                          Số điện thoại dùng để đăng kí tài khoản. Thông tin này có thể được dùng để xác minh bạn là chủ
                          sở hữu tài khoản nhằm thiết lập lại mật khẩu
                        </p>
                      </div>
                    </div>
                    <div className='flex gap-10'>
                ...
                {personalInfo && (
                  <div className='w-[880px] shadow-md p-10 transition-all '>
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className='mt-10' onClick={putChangePassword}>
