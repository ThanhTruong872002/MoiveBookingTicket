          ...
          <div className='flex gap-4 justify-between'>
            <div>
              <img
                ...
                alt=''
                className='w-[80px] h-10 rounded-md'
              />
            </div>
            <div className='text-[1.2rem] text-[#949494]'>
              <h2 className='text-white text-[1.4rem] '>TIX – SẢN PHẨM CỦA CÔNG TY CỔ PHẦN ZION</h2>
              <div className='leading-10'>
                ...
                <p>
                  Email: <span className='text-[#fb4226]'>truongtecu872002@gmail.com</span>
                </p>
              </div>
            </div>
            <div>
              <img src='https://touchcinema.com/images/icons/dathongbao.png' alt='' className='w-[165px] h-[62px]' />
            </div>
          </div>
        </div>
      </div>
